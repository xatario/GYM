...
namespace Gimnasio.Socios
{
    class clsSocio : Utilidades.clsModulo
    {
        ...
        public bool getDatos(System.Windows.Forms.DataGridView dgv, string busqueda)
        {
            clear();
            bool exito = false;
            try
            {
                ...
                dsGimnasio.vwsociosDataTable dt = ta.GetDataByNombre(busqueda); 
        ...
        public override bool add()
        {
            ...
            {
                dsGimnasioTableAdapters.socioTableAdapter ta = new dsGimnasioTableAdapters.socioTableAdapter();
                ta.add(Nombre, Paterno, Materno, Telefono, Observaciones, idUsuarioLog, foto,clave,huella);
        ...
        public override bool edit(int id)
        {
            ...
            {
                dsGimnasioTableAdapters.socioTableAdapter ta = new dsGimnasioTableAdapters.socioTableAdapter();
                ta.edit(Nombre, Paterno, Materno, Telefono, Observaciones, foto,clave, huella,id);
